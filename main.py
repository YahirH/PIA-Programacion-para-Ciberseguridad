...
def main():
    ...
    parser.add_argument("-op", "--option", dest="op", required=True,
                        help='Opción A =WebScrapping/Obtención de Metadatos/Envio de Correo con resultado. Opción B =API de revisión de dirección de Correo Opción C = Escaneo de puertos Opción D= Obtener el nombre de Dominio Completo de mi equipo')
